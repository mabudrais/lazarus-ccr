...
class TCustomListBox(TWinControl):
    def AddItem(self,AnObject,Item):
        r=PyMinMod.TCustomListBoxAddItem(self.pointer,AnObject.pointer,Item)
    def Click(self):
    ...
    def setItems(self,a1):
        r=PyMinMod.TCustomListBoxsetItems(self.pointer,a1.pointer)
    def getItems(self):
    ...
    def getSelCount(self):
        ...
        return r
    def setSelected(self,a1,Index):
        r=PyMinMod.TCustomListBoxsetSelected(self.pointer,a1,Index)
    def getSelected(self,Index):
        r=PyMinMod.TCustomListBoxgetSelected(self.pointer,Index)
        return r
