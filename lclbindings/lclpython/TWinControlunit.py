...
class TWinControl(TControl):
    ...
    def getControls(self,Index):
        r=PyMinMod.TWinControlgetControls(self.pointer,Index)
        ro=TControl()
        ro.pointer=r
        return ro
    ...
    def getDockClients(self,Index):
        r=PyMinMod.TWinControlgetDockClients(self.pointer,Index)
        ro=TControl()
        ro.pointer=r
        return ro
    ...
    def GetControlIndex(self,AControl):
        ...
        return r
    def SetControlIndex(self,NewIndex,AControl):
        r=PyMinMod.TWinControlSetControlIndex(self.pointer,NewIndex,AControl.pointer)
    def Focused(self):
    ...
    def InsertControl(self,Index,AControl):
        r=PyMinMod.TWinControlInsertControl(self.pointer,Index,AControl.pointer)
    def Repaint(self):
